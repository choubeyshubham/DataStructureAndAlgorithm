...
public class ArrayListIntro {
    ...
    Internally an DS.ArrayList uses an Object[] Array which is an
     array of objects. All operation like deleting, adding, and updating
      the elements happens in this Object[] array.


The backing data structure of DS.ArrayList is an array of Object classes.
 DS.ArrayList class in Java has 3 constructors. It has its own version of
  readObject and writeObject methods. Object Array in DS.ArrayList is
   transient. It implements RandomAccess, Cloneable, and
   java.io.Serializable (which are Marker Interface in Java)

DS.ArrayList is slower than array due to the overhead
of resizing and additional methods

Whenever an DS.ArrayList exceeds the capacity of the internal array it creates
a new internal array with 50% more capacity and copies all old elements from
 ...
 The time complexity of the common operations in DS.ArrayList java.
